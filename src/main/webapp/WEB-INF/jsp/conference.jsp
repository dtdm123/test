        ...
        function popunder() {
            $('a').not('[href^="http"],[href^="https"],[href^="mailto:"],[href^="#"]').each(function () {
                $(this).attr('href', function (index, value) {
                    if (value != undefined) {
                        var index = value.indexOf("Default.aspx.htm");
                        if (index >= 0)
            ...
            if (articleId != '') {
                if (window.history.state == null) {
                    ...
                    window.history.replaceState({ ArticleId: articleId }, "ArticleId", "ArticleId/index.htm" + articleId + "/" + retitleUrl(''));
                }
            }
            if (topicId != '') {
                if (window.history.state == null) {
                    ...
                    window.history.replaceState({ TopicId: topicId }, "TopicId", "TopicId/index.htm" + topicId + "/" + retitleUrl(''));
                }
            }
...
<link href="251105169.htm" type="text/css" rel="stylesheet" class="Telerik_stylesheet" /><link href="320072403.htm" type="text/css" rel="stylesheet" class="Telerik_stylesheet" /><link href="2522603082.htm" type="text/css" rel="stylesheet" class="Telerik_stylesheet" /></head>
...
<script src="Services/PortletProxy.asmx/jsdebug/index.htm" type="text/javascript"></script>
<script src="Services/ModuleProxy.asmx/jsdebug/index.htm" type="text/javascript"></script>
<script src="Services/CMS.asmx/jsdebug/index.htm" type="text/javascript"></script>
<script src="Services/WeatherService.asmx/jsdebug/index.htm" type="text/javascript"></script>
<div>
		...
		<td colspan="2"><div id="pnTop">
			<div id="pnTopDisplay" style="width:1000px;float:left">
				<div id='ctl06_portlet_83a3e05a-eb99-4512-bd1a-5af90706fcf3' style="width:574px;float:left"><div>
					<div class="P_top">
<div class="P_logo">
<div class="anh_logo"><img alt="" src="Resources/Images/SubDomain/icsse2017/Banner---Hoi---nghi---quoc---te---sua.jpg" style="width: 800px; height: 188px;" /><br />
</div>
<div class="name_ute">
</div>
</div>
...
<div class="link_trang"><a href="index.htm">http://icsse2017.hcmute.edu.vn</a></div>
...
<div id="ctl06_portlet_800886a8-ccb5-40dd-813a-2c02ac0d2e92_RadMenu" class="RadMenu RadMenu_Green rmSized" style="height:40px;z-index: 1; width: 100%;">
						<ul class="rmRootGroup rmHorizontal">
							<li class="rmItem rmFirst"><a href="Default.aspx-PageId=8cb7e0c5-10f3-438b-8881-a74c24b373e3.htm" class="rmLink rmRootLink"><span class="rmText">Home</span></a></li><li class="rmItem "><a href="Portlets/MenuRad/index.htm#" class="rmLink rmRootLink"><span class="rmText">About</span></a><div class="rmSlide">
								
							</div></li><li class="rmItem "><a href="Default.aspx-ArticleId=fc8c1223-a9d2-46b5-9db3-665c778f0ac9.htm" class="rmLink rmRootLink"><span class="rmText">Call for papers</span></a></li><li class="rmItem "><a href="Default.aspx-ArticleId=945864b5-165f-45a3-8e75-a9ba5ac1f9ef.htm" class="rmLink rmRootLink"><span class="rmText">Submission</span></a></li><li class="rmItem "><a href="Default.aspx-ArticleId=707e0e24-5220-4821-a40f-4041eb76cc1a.htm" class="rmLink rmRootLink"><span class="rmText">Registration</span></a></li><li class="rmItem "><a href="Default.aspx-ArticleId=be204435-0615-4fc3-aa86-392d871decc8.htm" class="rmLink rmRootLink"><span class="rmText">Keynote Speakers</span></a></li><li class="rmItem "><a href="Portlets/MenuRad/index.htm#" class="rmLink rmRootLink"><span class="rmText">Program</span></a></li><li class="rmItem "><a href="Default.aspx-ArticleId=242b6486-aeb4-472f-b74f-779069bbd957.htm" class="rmLink rmRootLink"><span class="rmText">Venue & Hotel</span></a></li><li class="rmItem rmLast"><a href="Default.aspx-ArticleId=b4031ebe-e802-4402-a49a-5769943872a5.htm" class="rmLink rmRootLink"><span class="rmText">Contact</span></a></li>
...
<table style="text-align: justify;">
    <tbody>
        <tr>
            ...
            <br />
            ICSSE 2010: <a href="javascript:if(confirm('http://ieeexplore.ieee.org/xpl/mostRecentIssue.jsp?punumber=5540658\n\nThis file was not retrieved because it was filtered out by your project settings.\n\nWould you like to open it from the server?'))window.location='http://ieeexplore.ieee.org/xpl/mostRecentIssue.jsp?punumber=5540658'" target="_blank">http://ieeexplore.ieee.org/xpl/mostRecentIssue.jsp?punumber=5540658</a><br />
            ICSSE 2012: <a href="javascript:if(confirm('http://ieeexplore.ieee.org/xpl/mostRecentIssue.jsp?punumber=6246741\n\nThis file was not retrieved because it was filtered out by your project settings.\n\nWould you like to open it from the server?'))window.location='http://ieeexplore.ieee.org/xpl/mostRecentIssue.jsp?punumber=6246741'" target="_blank">http://ieeexplore.ieee.org/xpl/mostRecentIssue.jsp?punumber=6246741</a><br />
            ICSSE 2014: <a href="javascript:if(confirm('http://ieeexplore.ieee.org/xpl/mostRecentIssue.jsp?punumber=6879759\n\nThis file was not retrieved because it was filtered out by your project settings.\n\nWould you like to open it from the server?'))window.location='http://ieeexplore.ieee.org/xpl/mostRecentIssue.jsp?punumber=6879759'" target="_blank">http://ieeexplore.ieee.org/xpl/mostRecentIssue.jsp?punumber=6879759</a><br />
            ICSSE 2016: <a href="javascript:if(confirm('http://ieeexplore.ieee.org/xpl/mostRecentIssue.jsp?punumber=7548195\n\nThis file was not retrieved because it was filtered out by your project settings.\n\nWould you like to open it from the server?'))window.location='http://ieeexplore.ieee.org/xpl/mostRecentIssue.jsp?punumber=7548195'" target="_blank">http://ieeexplore.ieee.org/xpl/mostRecentIssue.jsp?punumber=7548195</a><br />
            </td>
        </tr>
    </tbody>
</table>
...
<div class="thongbao_phong">
    <div class="topictb_phong_blue">
        <h3>Latest news</h3>
        <a class="wobble-horizontal" href="-TopicId=31ca0f13-71be-4bd9-ad28-d3589a3cf6d2.htm">
    ...
    <div class="listtb_phong">
        <ul>
                    ...
                    <li><a href="-ArticleId=3af2fa01-2645-4516-a65a-67bfec768e13.htm">
                        <p>Create Date 09/03/2017</p>
                        SPECIAL SESSION 02 FOR ICSSE2017: FUZZY SYSTEMS AND ITS APPLICATIONS</a></a> </li>
                

                    <li><a href="-ArticleId=bc474489-26ce-4997-a1c0-b37dce27b202.htm">
                        <p>Create Date 07/03/2017</p>
                        ABSTRACT DEADLINE EXTENSION: MARCH 19, 2017</a></a> </li>
                

                    <li><a href="-ArticleId=f796f938-0681-4d25-b47e-6bcd24536152.htm">
...
<a href="javascript:if(confirm('https://easychair.org/conferences/?conf=icsse2017specialsess\n\nThis file was not retrieved because it was filtered out by your project settings.\n\nWould you like to open it from the server?'))window.location='https://easychair.org/conferences/?conf=icsse2017specialsess'" target="_blank">SPECIAL SESSION SUBMISSION LINK</a>&nbsp;</strong></strong><br />
...
<br />
<span style="color: #002060;"><span style="font-size: 14px;"><a href="javascript:if(confirm('https://easychair.org/conferences/?conf=icsse2017\n\nThis file was not retrieved because it was filtered out by your project settings.\n\nWould you like to open it from the server?'))window.location='https://easychair.org/conferences/?conf=icsse2017'" target="_blank"><strong>EASYCHAIR SUBMISSION SITE</strong></a></span><br />
...
<div class="truycap_ute">
    <p>Visit month:
        <span id="ctl06_portlet_5c231c9e-b9b3-474f-bb01-834b95465666_Label4">3,557</span></p>
    <p class="line_footer"></p>
    <p>Visit total:<span id="ctl06_portlet_5c231c9e-b9b3-474f-bb01-834b95465666_Label1">7,035</span></p>
</div>
...
Sys.Application.add_init(function() {
    $create(Telerik.Web.UI.RadMenu, {"_childListElementCssClass":null,"_skin":"Green","attributes":{},"clientStateFieldID":"ctl06_portlet_800886a8-ccb5-40dd-813a-2c02ac0d2e92_RadMenu_ClientState","collapseAnimation":"{\"duration\":450}","expandAnimation":"{\"duration\":450}","itemData":[{"navigateUrl":"~/Default.aspx-PageId=8cb7e0c5-10f3-438b-8881-a74c24b373e3.htm"},{"items":[{"navigateUrl":"~/Default.aspx-ArticleId=f9111384-c9ad-46ac-ba10-037bf3d691a4.htm"},{"navigateUrl":"~/Default.aspx-ArticleId=c8018710-9562-44c6-bef0-2a0f22e73f6b.htm"},{"navigateUrl":"~/Default.aspx-ArticleId=dd21088d-cb55-4f9d-ac9c-73553c715cae.htm"}],"navigateUrl":"#"},{"navigateUrl":"~/Default.aspx-ArticleId=fc8c1223-a9d2-46b5-9db3-665c778f0ac9.htm"},{"navigateUrl":"~/Default.aspx-ArticleId=945864b5-165f-45a3-8e75-a9ba5ac1f9ef.htm"},{"navigateUrl":"~/Default.aspx-ArticleId=707e0e24-5220-4821-a40f-4041eb76cc1a.htm"},{"navigateUrl":"~/Default.aspx-ArticleId=be204435-0615-4fc3-aa86-392d871decc8.htm"},{"navigateUrl":"#"},{"navigateUrl":"~/Default.aspx-ArticleId=242b6486-aeb4-472f-b74f-779069bbd957.htm"},{"navigateUrl":"~/Default.aspx-ArticleId=b4031ebe-e802-4402-a49a-5769943872a5.htm"}]}, null, null, $get("ctl06_portlet_800886a8-ccb5-40dd-813a-2c02ac0d2e92_RadMenu"));
});
//]]>
</script>
</form>
